...
To document a security concern, communication is facilitated with the project curators:
  ...
  - **Method**: Reports are submitted via the repository’s [GitHub Issues](https://github.com/Amey-Thakur/FLAPPY-BIRD-USING-PYGAME/issues) interface to formally record security-related findings.
...
This project consists of a digital recreation of the Flappy Bird arcade game, utilizing Python and Pygame for physics simulation and game loop logic.

-   **Scope Limitation**: This policy applies exclusively to the documentation, code, and simulation assets contained within this repository and does not extend to the runtime environment or third-party libraries.
